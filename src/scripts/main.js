...
$(function () {
  ...
  function loadFormValidation() {
    ...
    $("#view_container")
      .off("click", "#btn_back").on("click", "#btn_back", function () {
      navigatetoStep(1);
    })
      .off("click", "#btn_back_2").on("click", "#btn_back_2", function () {
      navigatetoStep(2);
      //refreshCalculator();
    })
      .off("click", "#btn_forward").on("click", "#btn_forward", function () {
      showSessions();
    })
      .off("click", "#btn_calc").on("click", "#btn_calc", function () {
      calculatePT($('#propertyValue').val());
    })
      .off("click", "#btn_print").on("click", "#btn_print", function () {
      window.print();
    })
      .off("click", "#btn_calc_refresh").on("click", "#btn_calc_refresh", function () {
      refreshCalculator();
    })
...
/*
  ...
  function showSessions() {
    ...
    * */
              ...
              fields: [
                {
                  "id": "propertyValue",
                  "type": "text",
                  "title": config.propertyValueLabel,
                  "prehelptext":config.propertyValuePlaceHolder,
                  "required":true,
                  "className": "col-xs-12 col-sm-6",
                  "validators": {
                    numeric:{
                      message:config.propertyValueValidator,
                    }
                  }
                }
              ]
    ...
    upload_form.render({target: '#formArea'});
